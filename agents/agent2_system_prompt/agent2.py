...
if __name__ == '__main__':
    while True:
        input_ = input("You: ")
        chat(input_)
    # chat("Hi! My name is Arjun and I am a data scientist")
    # chat("I earn 120000 rupees per month")
    # chat("What is my monthly salary in USD?")
    # chat("If I save 30% of my salary every month, how much will I save in a year?")
    # chat("What is my name and what do I do?")   # ← tests memory